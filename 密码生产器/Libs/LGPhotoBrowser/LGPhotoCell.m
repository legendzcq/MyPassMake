...
+ (instancetype)cellWithCollectionView:(UICollectionView *)collectionView forIndexPaht:(NSIndexPath *)indexPath {
    static NSString *ID = @"LGPhotoCell";
    [collectionView registerClass:[LGPhotoCell class] forCellWithReuseIdentifier:ID];
    LGPhotoCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
    return cell;
}
...
- (void)setModel:(LGPhotoModel *)model {
    _model = model;
